...
execute as @p if score @s EMcraftedUA matches 1.. run give @s minecraft:carrot_on_a_stick{CustomModelData:16500,Enchantments:[{id:"something"}],display:{Name:"{\"text\":\"Unstable Anomaly\",\"color\":\"magenta\",\"italic\":false}"}} 1
...
execute as @a[nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:16500}}]}] if score @s EMbedrock matches 1.. run execute at @p positioned ~ ~1.5 ~ positioned ^ ^ ^1.2 run function expertmodeunstableanomaly:raycast
execute as @a[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:16500}}}] if score @s EMbedrock matches 1.. run execute at @p positioned ~ ~1.5 ~ positioned ^ ^ ^1.2 run function expertmodeunstableanomaly:raycast

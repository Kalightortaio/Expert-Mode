...
# Generate Pebbles
execute as @p[nbt={OnGround:1b}] at @s if score @p EMtime matches 61 in minecraft:overworld unless entity @e[tag=pebbleprocessed,distance=0..200] run function expertmodeearlyprogression:pebblegeneration